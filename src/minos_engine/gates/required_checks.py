    ...
    "MODELS-QUALIFIED": frozenset(
        {
            ...
            "training_runtime_exact_versions_verified",
            "training_dataset_built_by_accepted_authority",
            "caller_cannot_nominate_outcome_score_or_weight",
            # DATA
            ...
            "feature_names_exact_authoritative_columns",
            "feature_matrix_artifact_sha256_verified",
            ...
            "train_members_are_the_frozen_fifty",
            "row_chromosome_agrees_with_manifest",
            "exactly_three_train_campaigns",
            "scientific_pair_dedup_exact",
            "dedup_derived_not_audited",
            "conflicting_repeat_refused",
            ...
            "candidate_specs_from_accepted_factory",
            "reference_specs_frozen_and_hashed",
            "nested_calibration_no_outer_label_leak",
