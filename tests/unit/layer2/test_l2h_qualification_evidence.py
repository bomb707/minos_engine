...
def test_no_gate_was_issued_against_the_superseded_evidence() -> None:
    """SAFE-CONTROLLER-FROZEN exists, but it names v3 -- never v1 or v2."""
    ...
    for entry in HISTORICAL.values():
        assert bound != entry["file_sha"], f"the gate binds superseded evidence {entry['schema']}"
