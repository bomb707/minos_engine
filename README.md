...
## Next stage
**Layer 2 — PostgreSQL experiment system + GATK controller.** Do not begin until
the public GitHub repository is reviewed and the next stage is explicitly approved.
Layer 2 remains blocked until `l1-ready.json` verifies through the entry gate.
